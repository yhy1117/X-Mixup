...
from xmixup.utils.file_utils import CONFIG_NAME, cached_path, hf_bucket_url, is_remote_url
...
class PretrainedConfig(object):
    ...
    def get_config_dict(cls, pretrained_model_name_or_path: str, **kwargs) -> Tuple[Dict, Dict]:
        ...
        elif tf.io.gfile.exists(pretrained_model_name_or_path) or is_remote_url(pretrained_model_name_or_path):
    ...
    def to_json_file(self, json_file_path, use_diff=True):
        ...
        """
        with tf.io.gfile.GFile(json_file_path, "w") as writer:
